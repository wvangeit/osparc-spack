...
class Osparc(Package):
    ...
    url = "https://github.com/ITISFoundation/osparc-simcore/archive/refs/tags/v1.0.0.tar.gz"
    ...
    #
    # # Conflicts
    # conflicts("platform=windows", msg="Windows is not supported. Use WSL2 instead.")
    #
...
""")
    ...
    def post_install_message(self):
        """Display post-installation information following project guidelines."""
